...
public class ShipmentsPane extends JPanel
{
	...
	/**
	 * JTable for data Double click a row to update shipments
	 */
	public ShipmentsPane()
	{
		...
		shipList.setRowHeight(45);
		// Add JTable to JScrollPane to make scrollable
		JScrollPane shipPane = new JScrollPane(shipList, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
